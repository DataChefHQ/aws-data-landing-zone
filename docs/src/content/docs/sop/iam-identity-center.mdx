...
Refer to the [SOP - IAM Identity Center Internal Directory](/sop/iam-identity-center-setup-internal) for detailed instructions.
...
Refer to the [SOP - IAM Identity Center External Identity Provider](/sop/iam-identity-center-setup-external) for detailed
instructions.
