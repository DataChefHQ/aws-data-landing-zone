...
Tower. Alternatively, create a new root AWS account by signing up at
...
This account will be referred to as the `root`/management account.
...
1. Log in to the `root` account and navigate to [Control Tower](https://console.aws.amazon.com/controltower)
