...
| `CostCenter` | Finance cost centre for chargeback |
...
- **Cost Allocation Tags:** Mandatory tag set (`Owner`, `Project`, `Environment`, `CostCenter`, `Name`) activated automatically and enforced at deploy time.
