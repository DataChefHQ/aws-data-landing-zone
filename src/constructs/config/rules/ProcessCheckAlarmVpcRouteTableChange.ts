 ...
 */
export class ProcessCheckAlarmVpcRouteTableChange implements IDlzConfigRule {
  readonly configRuleName = 'alarm-vpc-route-table-change';
  readonly description = 'Ensure a log metric filter and an alarm exists for route table changes. https://docs.aws.amazon.com/config/latest/developerguide/aws-config-process-check.html';
