 ...
 */
export class ProcessCheckAlarmAwsConfigChange implements IDlzConfigRule {
  readonly configRuleName = 'alarm-aws-config-change';
  readonly description = 'Ensure a log metric filter and an alarm exists for AWS Config configuration changes. https://docs.aws.amazon.com/config/latest/developerguide/aws-config-process-check.html';
