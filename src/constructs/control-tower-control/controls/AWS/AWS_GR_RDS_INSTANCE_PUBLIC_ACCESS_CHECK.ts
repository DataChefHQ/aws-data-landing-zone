...
export class AWS_GR_RDS_INSTANCE_PUBLIC_ACCESS_CHECK implements IDlzControlTowerControl {
  public readonly controlFriendlyName = DlzControlTowerStandardControls.AWS_GR_RDS_INSTANCE_PUBLIC_ACCESS_CHECK;
  ...
  public readonly controlIdName = {
    euWest1: 'AWS-GR_RDS_INSTANCE_PUBLIC_ACCESS_CHECK',
    usEast1: 'AWS-GR_RDS_INSTANCE_PUBLIC_ACCESS_CHECK',
  };
}